// Link to problem :
// https://codedamn.com/problem/hNGVfUpOv_aXzkEMZG_2d?challengeList=hacktoberfest-2023

// corrected the code to give the correct output for odd length array 
// change this line : return arr[Math.floor(arr.length / 2) -1 ];
// to this : return arr[Math.floor(arr.length / 2) ];
